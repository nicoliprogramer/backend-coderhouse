...
console.log(`La multiplicacion de ${num1} y ${num2} es de ${operaciones.multiplicacion(num1,num2)}`)
console.log(`La division de ${num1} y ${num2} es de ${operaciones.division(num1,num2)}`)